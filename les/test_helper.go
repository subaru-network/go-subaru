...
import (
	...
	"github.com/subaru-network/go-subaru/accounts/abi/bind/backends"
	...
	"github.com/subaru-network/go-subaru/contracts/checkpointoracle/contract"
	"github.com/subaru-network/go-subaru/core"
	"github.com/subaru-network/go-subaru/core/forkid"
	...
	"github.com/subaru-network/go-subaru/les/checkpointoracle"
	"github.com/subaru-network/go-subaru/les/flowcontrol"
	vfs "github.com/subaru-network/go-subaru/les/vflux/server"
...
func prepare(n int, backend *backends.SimulatedBackend) {
	...
	for i := 0; i < n; i++ {
		...
		case 0:
			...
			// bankUser transfers some su to user1
		...
		case 1:
			...
			// bankUser transfers more su to user1
		...
		case 2:
			...
			// bankUser transfer some su to signer
			bankNonce, _ := backend.PendingNonceAt(ctx, bankAddr)
