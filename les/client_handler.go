...
func newClientHandler(ulcServers []string, ulcFraction int, checkpoint *params.TrustedCheckpoint, backend *LightSubaru) *clientHandler {
...
func (h *clientHandler) handle(p *serverPeer, noInitAnnounce bool) error {
	...
	if err := h.backend.peers.register(p); err != nil {
		p.Log().Error("Light Subaru peer registration failed", "err", err)
		return err
	}
