...
import (
	...
	ethdownloader "github.com/subaru-network/go-subaru/eth/downloader"
	...
	"github.com/subaru-network/go-subaru/p2p/simulations"
	"github.com/subaru-network/go-subaru/p2p/simulations/adapters"
...
func newLesServerService(ctx *adapters.ServiceContext, stack *node.Node) (node.Lifecycle, error) {
	...
	subaru, err := eth.New(stack, &config)
	if err != nil {
		return nil, err
	}
	_, err = NewLesServer(stack, subaru, &config)
	if err != nil {
		return nil, err
	}
	return subaru, nil
