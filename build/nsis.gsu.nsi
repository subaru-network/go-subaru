...
# 1. install gsu for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gsu
# 5. create gsu, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable SUBARU_SOCKET
...
!define GROUPNAME "Subaru"
!define APPNAME "Gsu"
!define DESCRIPTION "Official Go implementation of the Subaru protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gsu is installed global
