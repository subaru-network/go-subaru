Name "gsu ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/subaru-network/go-subaru/issues"
!define UPDATEURL "https://github.com/subaru-network/go-subaru/releases"
!define ABOUTURL "https://github.com/subaru-network/go-subaru#subaru-go"
...
Section "Gsu" GSU_IDX
  ...
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gsu.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gsu.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gsu incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gsu outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gsu UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gsu incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gsu.exe" "" "" "Subaru" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gsu outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gsu.exe" "" "" "Subaru" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gsu UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gsu.exe" "" "" "Subaru" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "SUBARU_SOCKET" "R" "HKLM" "\\.\pipe\gsu.ipc"
  ${EnvVarUpdate} $0 "SUBARU_SOCKET" "A" "HKLM" "\\.\pipe\gsu.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GSU_IDX}
    SectionGetSize ${GSU_IDX} $0
