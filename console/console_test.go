...
func newTester(t *testing.T, confOverride func(*ethconfig.Config)) *tester {
	...
	// Create a networkless protocol stack and start an Subaru service within
	...
	ethConf := &ethconfig.Config{
		...
		Miner: miner.Config{
			Subase: common.HexToAddress(testAddress),
		},
	...
	if err != nil {
		t.Fatalf("failed to register Subaru protocol: %v", err)
	}
