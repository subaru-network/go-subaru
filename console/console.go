...
import (
	...
	"github.com/subaru-network/go-subaru/internal/jsre"
	"github.com/subaru-network/go-subaru/internal/jsre/deps"
	"github.com/subaru-network/go-subaru/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute Subaru requests through
...
// Welcome show summary of current Gsu instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the Gsu JavaScript console!\n\n"

	// Print some generic Gsu metadata
