...
// mapped from textual names used in the tests below to actual Subaru private
...
// address retrieves the Subaru address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Subaru address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/subaru-network/go-subaru/issues/17593). Whilst this
