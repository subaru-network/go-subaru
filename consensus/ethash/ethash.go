...
// all blocks' seal as valid, though they still have to conform to the Subaru
// consensus rules.
...
// still have to conform to the Subaru consensus rules.
...
// they still have to conform to the Subaru consensus rules.
