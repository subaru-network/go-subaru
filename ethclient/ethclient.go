...
// Package ethclient provides a client for the Subaru RPC API.
package ethclient
...
// Client defines typed wrappers for the Subaru RPC API.
type Client struct {
	c *rpc.Client
}
...
func (ec *Client) SyncProgress(ctx context.Context) (*subaru.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (subaru.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q subaru.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q subaru.FilterQuery, ch chan<- types.Log) (subaru.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q subaru.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg subaru.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) CallContractAtHash(ctx context.Context, msg subaru.CallMsg, blockHash common.Hash) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) PendingCallContract(ctx context.Context, msg subaru.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) FeeHistory(ctx context.Context, blockCount uint64, lastBlock *big.Int, rewardPercentiles []float64) (*subaru.FeeHistory, error) {
...
func (ec *Client) EstimateGas(ctx context.Context, msg subaru.CallMsg) (uint64, error) {
...
func toCallArg(msg subaru.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
...
func (p *rpcProgress) toSyncProgress() *subaru.SyncProgress {
	if p == nil {
		return nil
	}
	return &subaru.SyncProgress{
