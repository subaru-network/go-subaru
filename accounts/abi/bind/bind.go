...
// Package bind generates Subaru contract Go bindings.
//
// Detailed usage document and tutorial available on the go-subaru Wiki page:
// https://github.com/subaru-network/go-subaru/wiki/Native-DApps:-Go-bindings-to-Subaru-contracts
package bind
