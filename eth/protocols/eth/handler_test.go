...
// testBackend is a mock implementation of the live Subaru message handler. Its
...
func testGetNodeData(t *testing.T, protocol uint) {
	...
	generator := func(i int, block *core.BlockGen) {
		switch i {
		case 0:
			// In block 1, the test bank sends account #1 some su.
			...
			block.AddTx(tx)
		case 1:
			// In block 2, the test bank sends some more su to account #1.
