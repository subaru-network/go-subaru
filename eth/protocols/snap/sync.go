...
import (
	...
	"github.com/subaru-network/go-subaru/p2p/msgrate"
...
// Syncer is an Subaru account and storage trie syncer based on snapshots and
...
// NewSyncer creates a new snapshot syncer to download the Subaru state over the
// snap protocol.
