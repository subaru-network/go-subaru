...
// Syncing provides information when this nodes starts synchronising with the Subaru network and when it's finished.
...
type SyncingResult struct {
	...
	Status  subaru.SyncProgress `json:"status"`
}
