...
pruning. Remember don't start the Gsu without deleting the clean trie cache
otherwise the entire database may be damaged!

Check the command description "gsu snapshot prune-state --help" for more details.
`
