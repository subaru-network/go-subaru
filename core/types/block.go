...
// Package types contains data types related to Subaru consensus.
package types
...
// Header represents a block header in the Subaru blockchain.
type Header struct {
...
// Block represents an entire block in the Subaru blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the Subaru RLP block format.
