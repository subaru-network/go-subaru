...
// It can be used for testing that restart Gsu normally.
...
// It can be used for testing that restart Gsu after the crash.
...
// Tests a Gsu restart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a Gsu was crashed and restarts with a broken snapshot. In this case the
...
// Tests a Gsu was crashed and restarts with a broken snapshot. In this case
...
// Tests a Gsu was running with snapshot enabled. Then restarts without
...
// Tests the Gsu was running with snapshot enabled and resetHead is applied.
...
// Tests the Gsu was running with a complete snapshot and then imports a few
