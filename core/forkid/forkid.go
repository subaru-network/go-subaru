...
// NewID calculates the Subaru fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the Subaru fork ID from an existing chain instance.
