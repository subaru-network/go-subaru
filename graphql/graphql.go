...
// Package graphql provides a GraphQL interface to Subaru node data.
package graphql
...
// Account represents an Subaru account at a particular block.
type Account struct {
	r             *Resolver
...
// Transaction represents an Subaru transaction.
...
// Block represents an Subaru block.
...
type CallData struct {
	From                 *common.Address // The Subaru address the call is from.
	To                   *common.Address // The Subaru address the call is to.
