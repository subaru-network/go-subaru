...
// setting up a new or managing an existing Subaru private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Subaru private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Subaru network down to  |")
	...
	log.Info("Administering Subaru network", "name", w.network)
