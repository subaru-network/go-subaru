...
type wizard struct {
	...
	services map[string][]string   // Subaru services known to be running on servers
...
// converts it to an Subaru address. If an empty line is entered, the default
// value is returned.
