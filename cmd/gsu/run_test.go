...
import (
	...
	"github.com/subaru-network/go-subaru/internal/cmdtest"
...
func init() {
	// Run the app if we've been exec'd as "gsu-test" in runGsu.
	reexec.Register("gsu-test", func() {
...
// spawns gsu with the given command line args. If the args don't set --datadir, the
// child g gets a temporary data directory.
func runGsu(t *testing.T, args ...string) *testgsu {
	tt := &testgsu{}
	...
	// Boot "gsu". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("gsu-test", args...)
