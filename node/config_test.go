...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gsu.ipc", false, filepath.Join(os.TempDir(), "gsu.ipc")},
		{"data", "gsu.ipc", false, "data/gsu.ipc"},
		{"data", "./gsu.ipc", false, "./gsu.ipc"},
		{"data", "/gsu.ipc", false, "/gsu.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gsu.ipc", true, `\\.\pipe\gsu.ipc`},
		{"data", "gsu.ipc", true, `\\.\pipe\gsu.ipc`},
		{"data", `\\.\pipe\gsu.ipc`, true, `\\.\pipe\gsu.ipc`},
	}
