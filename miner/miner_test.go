...
// Package miner implements Subaru block creation and mining.
package miner
...
import (
	...
	"github.com/subaru-network/go-subaru/ethdb/memorydb"
...
// TestMinerSetSubase checks that etherbase becomes set even if mining isn't
// possible at the moment
func TestMinerSetSubase(t *testing.T) {
	miner, mux, cleanup := createMiner(t)
	defer cleanup(false)
...
func createMiner(t *testing.T) (*Miner, *event.TypeMux, func(skipMiner bool)) {
	...
	config := Config{
		Subase: common.HexToAddress("123456789"),
	}
	// Create chainConfig
	memdb := memorydb.New()
