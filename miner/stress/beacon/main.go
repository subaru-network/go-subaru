...
import (
	...
	"github.com/subaru-network/go-subaru/core/beacon"
...
type ethNode struct {
	...
	ethBackend *eth.Subaru
	lapi       *lescatalyst.ConsensusAPI
	lesBackend *les.LightSubaru
}
...
func makeFullNode(genesis *core.Genesis) (*node.Node, *eth.Subaru, *ethcatalyst.ConsensusAPI, error) {
	// Define the basic configurations for the Subaru node
	...
	// Create the node and configure a full Subaru node on it
...
func makeLightNode(genesis *core.Genesis) (*node.Node, *les.LightSubaru, *lescatalyst.ConsensusAPI, error) {
	// Define the basic configurations for the Subaru node
	datadir, _ := os.MkdirTemp("", "")
